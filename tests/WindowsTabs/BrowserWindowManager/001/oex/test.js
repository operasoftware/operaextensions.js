opera.isReady(function() {
    try {
        w = [ windows.create(), // no tabs, no properties
        ...
        windows.create(undefined, undefined), // undefined tabs, undefined
        // properties
    ...
    test(function() {
        assert_exists(windows.__proto__, "create", "create method");
    }, "Interface check: BrowserWindowManager.create");
    test(function() {
        assert_exists(windows.__proto__, "getAll", "getAll method");
    }, "Interface check: BrowserWindowManager.getAll");
    test(function() {
        assert_exists(windows.__proto__, "getLastFocused", "getLastFocused method");
    }, "Interface check: BrowserWindowManager.getLastFocused");
