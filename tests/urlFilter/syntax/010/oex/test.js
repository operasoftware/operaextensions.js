opera.isReady({
    ...
    block.add("*pass.png*");
    allow.add("https://ssl.opera.com:8*2/resources/images/pass.png");
    ...
    opera.extension.onmessage = function(evt) {
    	...
    	if (evt.data.type === "contentunblocked") {
    		tests["port"].step(function(){
    			assert_equals(evt.data.url, "https://ssl.opera.com:8012/resources/images/pass.png", "The correct URL should be blocked.");
    		});
