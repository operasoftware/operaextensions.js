opera.isReady({
    ...
    tests["block"] = async_test("The rule should not block on domains that are included.");
    tests["allow"] = async_test("The rule should only allow on domains that are included.");
    
    block.add("*images/*.png*");
    allow.add("*images/*.png*", {includeDomains: ["t", "invalid\uFFFE\u0000", "testsuites.oslo.osa", "partial.aliases.t.oslo.osa", "aaaaaaaaaabbbbbbbbbbccccccccccddddddddddeeeeeeeeeeffffffffffggg.aaaaaaaaaabbbbbbbbbbccccccccccddddddddddeeeeeeeeeeffffffffffggg.aaaaaaaaaabbbbbbbbbbccccccccccddddddddddeeeeeeeeeeffffffffffggg.aaaaaaaaaabbbbbbbbbbccccccccccddddddddddee.aliases.t.oslo.osa"]});
