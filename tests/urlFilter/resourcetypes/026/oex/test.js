opera.isReady(function() {
    ...
    tests["block"] = async_test("Blocking by resource type: xmlhttprequest");
    block.add("*fail.html*", {resources: types("xmlhttprequest")});
    ...
    createTab({url: "http://t/core/features/widget_tf/core-gadgets/extensions/url-filter/resources/xhr.html"});
