opera.isReady(function() {
    ...
    tests["block"] = async_test("Blocking by resource type: media (audio).");
    ...
    opera.extension.onmessage = function(evt) {
    	...
    	if (evt.data.type === "contentblocked") {
    		tests["block"].step(function(){
    			...
    			assert_equals(evt.data.tagName.toUpperCase(), "AUDIO", "The correct element should be blocked.");
    		});
    ...
    createTab({url: "http://t/core/features/widget_tf/core-gadgets/extensions/url-filter/resources/audio.html"});
