opera.isReady({
    ...
    tests["block"] = async_test("Blocking by resource type: font.");
    block.add("*Ahem-webonly.woff*", {resources: types("font")});
    ...
    opera.extension.onmessage = function(evt) {
    	...
    	if (evt.data.type === "contentblocked") {
    		tests["block"].step(function(){
    			assert_equals(evt.data.url, "http://t/resources/fonts/Ahem-webonly.woff", "The correct URL should be blocked.");
    ...
    createTab({url: "http://t/core/features/widget_tf/core-gadgets/extensions/url-filter/resources/font.html"});
