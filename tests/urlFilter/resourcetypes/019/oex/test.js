opera.isReady({
    ...
    tests["block"] = async_test("Blocking by resource type: stylesheet (@import).");
    block.add("*fail.css*", {resources: types("stylesheet")});
    ...
    opera.extension.onmessage = function(evt) {
    	...
    	if (evt.data.type === "contentblocked") {
    		tests["block"].step(function(){
    			assert_equals(evt.data.url, "http://t/resources/fail.css", "The correct URL should be blocked.");
    ...
    var data = "<!DOCTYPE html><style>@import \"http://t/resources/fail.css\";</style>If you can read this, the stylesheet was blocked. PASS only if a contentblocked event was fired.";
