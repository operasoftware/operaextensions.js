opera.isReady(function() {
    ...
    tests["block"] = async_test("Blocking by resource type: subdocument (iframe).");
    ...
    opera.extension.onmessage = function(evt) {
    	...
    	if (evt.data.type === "contentblocked") {
    		tests["block"].step(function(){
    			...
    			assert_equals(evt.data.tagName.toUpperCase(), "IFRAME", "The correct element should be blocked.");
    		});
    ...
    var data = "<!DOCTYPE html><iframe src='http://t/resources/fail.html'></iframe>";
