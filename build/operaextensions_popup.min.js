...
'use strict';!function(c){function m(a,d,f){k?a[d].apply(a,f):i.push({target:a,methodName:d,args:f})}var e=function(){};e.prototype.REVISION="1";e.prototype.version=function(){return this.REVISION};e.prototype.buildNumber=function(){return this.REVISION};e.prototype.postError=function(a){console.log(a)};var h=c.opera||new e,e=chrome.app.getDetails(),k=!1,i=[],x={},l={},b="undefined"!==typeof window?window:{},b=b.MutationObserver||b.WebKitMutationObserver;if("undefined"!==typeof process&&"[object process]"===
{}.toString.call(process))b=function(a,d){process.nextTick(function(){a.call(d)})};else if(b){var u=[],b=new b(function(){var a=u.slice();u=[];a.forEach(function(a){a[0].call(a[1])})}),y=document.createElement("div");b.observe(y,{attributes:!0});b=function(a,d){u.push([a,d]);y.setAttribute("drainQueue","drainQueue")}}else b=function(a,d){setTimeout(function(){a.call(d)},1)};l.async=b;var E=l.Event=function(a,d){this.type=a;for(var f in d)d.hasOwnProperty(f)&&(this[f]=d[f])},z=function(a,d){for(var f=
