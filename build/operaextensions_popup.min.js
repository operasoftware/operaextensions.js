...
this[0].dispatchEvent(new o("click",{}));this.dispatchEvent(new o("click",{}))}.bind(this));this.isBackground&&r.addEventListener("controlmessage",function(a){if(a.data&&a.data.action&&"___O_setup_toolbar_context_REQUEST"==a.data.action)if(this[0]){var c=Object.create(this[0].properties);c.badge=c.badge.properties;c.popup=c.popup.properties;a.source.postMessage({action:"___O_setup_toolbar_context_RESPONSE",data:{toolbarUIItem_obj:c}})}else a.source.postMessage({action:"___O_setup_toolbar_context_RESPONSE",
data:{toolbarUIItem_obj:void 0}})}.bind(this),!1)};x.prototype=Object.create(g.prototype);x.prototype.createItem=function(a){return new j(a)};x.prototype.addItem=function(a){a&&!(!a instanceof j)&&(this[0]=a,this.length=1,a.resolve(!0),a.apply(),a.badge.resolve(!0),a.badge.apply(),a.popup.resolve(!0),a.popup.apply())};x.prototype.removeItem=function(a){a&&!(!a instanceof j)&&(this[0]&&this[0]===a)&&(delete this[0],this.length=0,chrome.browserAction.disable(),a.dispatchEvent(new o("remove",{})),this.dispatchEvent(new o("remove",
{})))};var l=function(a){n.call(this);this.properties={};this.properties.textContent=a.textContent?""+a.textContent:a.textContent;this.properties.backgroundColor=C(a.backgroundColor);this.properties.color=C(a.color);this.properties.display="none"===String(a.display).toLowerCase()?"none":"block"};l.prototype=Object.create(A.prototype);l.prototype.apply=function(){chrome.browserAction.setBadgeBackgroundColor({color:this.backgroundColor||"#f00"});"block"===this.display?chrome.browserAction.setBadgeText({text:this.textContent||
""}):chrome.browserAction.setBadgeText({text:""})};l.prototype.__defineGetter__("textContent",function(){return this.properties.textContent});l.prototype.__defineSetter__("textContent",function(a){this.properties.textContent=""+a;"block"===this.properties.display&&k.enqueue(this,function(b){chrome.browserAction.setBadgeText({text:""+a});b()}.bind(this))});l.prototype.__defineGetter__("backgroundColor",function(){return this.properties.backgroundColor});l.prototype.__defineSetter__("backgroundColor",
function(a){this.properties.backgroundColor=C(a);k.enqueue(this,function(a){chrome.browserAction.setBadgeBackgroundColor({color:this.properties.backgroundColor});a()}.bind(this))});l.prototype.__defineGetter__("color",function(){return this.properties.color});l.prototype.__defineSetter__("color",function(a){this.properties.color=C(a)});l.prototype.__defineGetter__("display",function(){return this.properties.display});l.prototype.__defineSetter__("display",function(a){"none"===(""+a).toLowerCase()?
(this.properties.display="none",k.enqueue(this,function(a){chrome.browserAction.setBadgeText({text:""});a()}.bind(this))):(this.properties.display="block",k.enqueue(this,function(a){chrome.browserAction.setBadgeText({text:this.properties.textContent});a()}.bind(this)))});var p=function(a){n.call(this);this.properties={href:"",width:300,height:200};this.isExternalHref=!1;this.href=a.href;this.width=a.width;this.height=a.height;this.applyHrefVal=function(){return!0===this.isExternalHref?"/oex_shim/popup_resourceloader.html?href="+
f.btoa(this.properties.href)+"&w="+this.properties.width+"&h="+this.properties.height:this.properties.href}};p.prototype=Object.create(A.prototype);p.prototype.apply=function(){chrome.browserAction.setPopup({popup:this.applyHrefVal()})};p.prototype.__defineGetter__("href",function(){return this.properties.href});p.prototype.__defineSetter__("href",function(a){a+="";this.isExternalHref=a.match(/^(https?:\/\/|data:)/)?!0:!1;this.properties.href=a;k.enqueue(this,function(a){chrome.browserAction.setPopup({popup:this.applyHrefVal()});
a()}.bind(this))});p.prototype.__defineGetter__("width",function(){return this.properties.width});p.prototype.__defineSetter__("width",function(a){a=(a+"").replace(/\D/g,"");this.properties.width=""==a?300:800>a?a:800;k.enqueue(this,function(a){chrome.browserAction.setPopup({popup:this.applyHrefVal()});a()}.bind(this))});p.prototype.__defineGetter__("height",function(){return this.properties.height});p.prototype.__defineSetter__("height",function(a){a=(a+"").replace(/\D/g,"");this.properties.height=
""==a?200:600>a?a:600;k.enqueue(this,function(a){chrome.browserAction.setPopup({popup:this.applyHrefVal()});a()}.bind(this))});var j=function(a){n.call(this);this.properties={};this.properties.disabled=a.disabled||!1;this.properties.title=a.title||"";this.properties.icon=a.icon||"";this.properties.popup=new p(a.popup||{});this.properties.badge=new l(a.badge||{});a.onclick&&(this.onclick=a.onclick);a.onremove&&(this.onremove=a.onremove)};j.prototype=Object.create(A.prototype);j.prototype.apply=function(){chrome.browserAction.setTitle({title:this.title});
this.icon&&chrome.browserAction.setIcon({path:this.icon});!0===this.disabled?chrome.browserAction.disable():chrome.browserAction.enable()};j.prototype.__defineGetter__("disabled",function(){return this.properties.disabled});j.prototype.__defineSetter__("disabled",function(a){this.properties.disabled!==a&&(!0===a||"true"===a||1===a||"1"===a?(this.properties.disabled=!0,k.enqueue(this,function(a){chrome.browserAction.disable();a()}.bind(this))):(this.properties.disabled=!1,k.enqueue(this,function(a){chrome.browserAction.enable();
a()}.bind(this))))});j.prototype.__defineGetter__("title",function(){return this.properties.title});j.prototype.__defineSetter__("title",function(a){this.properties.title=""+a;k.enqueue(this,function(a){chrome.browserAction.setTitle({title:this.title});a()}.bind(this))});j.prototype.__defineGetter__("icon",function(){return this.properties.icon});j.prototype.__defineSetter__("icon",function(a){this.properties.icon=""+a;k.enqueue(this,function(a){chrome.browserAction.setIcon({path:this.icon});a()}.bind(this))});
j.prototype.__defineGetter__("popup",function(){return this.properties.popup});j.prototype.__defineGetter__("badge",function(){return this.properties.badge});g=function(){x.call(this,!1);r.addEventListener("controlmessage",function(a){a.data&&a.data.action&&"___O_setup_toolbar_context_RESPONSE"==a.data.action&&(void 0!==a.data.data.toolbarUIItem_obj&&null!==a.data.data.toolbarUIItem_obj&&(this[0]=new j(a.data.data.toolbarUIItem_obj),this.length=1),y.TOOLBAR_CONTEXT_LOADED=!0)}.bind(this),!1);r.postMessage({action:"___O_setup_toolbar_context_REQUEST",
data:{}})};g.prototype=Object.create(x.prototype);D&&(void 0!==D.browser_action&&null!==D.browser_action)&&(m.toolbar=m.toolbar||new g);if(f.opera)v=!0,q.isReady=function(a){a.call(q);for(var a=0,b=s.length;a<b;a++){var c=s[a];c.target[c.methodName].apply(c.target,c.args)}s=[]};else{m=function(a,b){var c=a.addEventListener;a.addEventListener=function(e,d,g){e=e+"";e.toLowerCase()===b.toLowerCase()?d===void 0||(d===null||Object.prototype.toString.call(d)!=="[object Function]")||(v?d.call(f):u[b.toLowerCase()].push(d)):
c.call(a,e,d,g)};a.__defineSetter__("on"+b.toLowerCase(),function(c){a.addEventListener(b.toLowerCase(),c,false)})};var B=function(a,b,c){for(var a=a.toLowerCase(),c=new o(a,c||{}),e=0,d=u[a].length;e<d;e++)u[a][e].call(b,c)},u={isready:[],readystatechange:[],domcontentloaded:[],load:[]},R=!1,G=!1;f.document.addEventListener("DOMContentLoaded",function b(){R=true;f.document.removeEventListener("DOMContentLoaded",b,true)},!0);f.addEventListener("load",function c(){G=true;f.removeEventListener("load",
c,true)},!0);f.document.addEventListener("readystatechange",function(c){c.stopImmediatePropagation();c.stopPropagation();f.document.readyState!=="interactive"&&f.document.readyState!=="complete"?B("readystatechange",f.document):f.document.readyState="loading"},!0);var S="uninitialized";f.document.__defineSetter__("readyState",function(c){S=c});f.document.__defineGetter__("readyState",function(){return S});m(f,"load");m(f.document,"domcontentloaded");m(f,"domcontentloaded");m(f.document,"readystatechange");
var X=(new Date).getTime()+3E3;(function e(){if((new Date).getTime()>=X){console.warn("opera.isReady check timed out");G=true}else for(var d in y)if(y[d]!==true){f.setTimeout(function(){e()},20);return}f.setTimeout(function(){if(!v){for(var d=0,e=u.isready.length;d<e;d++)u.isready[d].call(f);u.isready=[];var g=(new Date).getTime()+3E3;(function T(){var d=(new Date).getTime();if(R||G||d>=g){f.document.readyState="interactive";B("readystatechange",f.document);B("domcontentloaded",f.document,{bubbles:true});
d>=g&&console.warn("document.domcontentloaded event fired on check timeout");var e=(new Date).getTime()+3E3;(function U(){var d=(new Date).getTime();if(G||d>=e){f.document.readyState="complete";B("readystatechange",f.document);B("load",window);d>=e&&console.warn("window.load event fired on check timeout");for(var d=0,g=s.length;d<g;d++){var h=s[d];h.target[h.methodName].apply(h.target,h.args)}s=[]}else f.setTimeout(function(){U()},50)})()}else f.setTimeout(function(){T()},50)})();v=true}},0)})();
q.isReady=function(e){v?e.call(f):u.isready.push(e)}}f.opera=q}(window);
