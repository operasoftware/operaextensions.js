...
document.addEventListener("DOMContentLoaded",function(){for(var c="load click mouseover mouseout keydown keypress keyup blur focus".split(" "),g=0,d=c.length;g<d;g++)for(var i=document.querySelectorAll("[on"+c[g]+"]"),j=0,k=i.length;j<k;j++){var r=new Function("e",i[j].getAttribute("on"+c[g])),l=i[j];"load"===c[g]&&i[j]===document.body&&(l=window);i[j].removeAttribute("on"+c[g]);l.addEventListener(c[g],r,!0)}},!1);
