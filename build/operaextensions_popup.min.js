...
a()}.bind(this))):(this.properties.display="block",k.enqueue(this,function(a){chrome.browserAction.setBadgeText({text:this.properties.textContent});a()}.bind(this)))});var p=function(a){n.call(this);this.properties={};this.properties.href=a.href||"";this.properties.width=a.width||300;this.properties.height=a.height||200;this.isExternalHref=!1;this.applyHrefVal=function(){return!0===this.isExternalHref?"/oex_shim/popup_resourceloader.html?href="+f.btoa(this.properties.href)+"&w="+this.properties.width+
"&h="+this.properties.height:this.properties.href}};p.prototype=Object.create(A.prototype);p.prototype.apply=function(){chrome.browserAction.setPopup({popup:this.applyHrefVal()})};p.prototype.__defineGetter__("href",function(){return this.properties.href});p.prototype.__defineSetter__("href",function(a){a+="";this.isExternalHref=a.match(/^https?:\/\//)?!0:!1;this.properties.href=a;k.enqueue(this,function(a){chrome.browserAction.setPopup({popup:this.applyHrefVal()});a()}.bind(this))});p.prototype.__defineGetter__("width",
function(){return this.properties.width});p.prototype.__defineSetter__("width",function(a){a=(a+"").replace(/\D/g,"");this.properties.width=""==a?300:a;k.enqueue(this,function(a){chrome.browserAction.setPopup({popup:this.applyHrefVal()});a()}.bind(this))});p.prototype.__defineGetter__("height",function(){return this.properties.height});p.prototype.__defineSetter__("height",function(a){a=(a+"").replace(/\D/g,"");this.properties.height=""==a?200:a;k.enqueue(this,function(a){chrome.browserAction.setPopup({popup:this.applyHrefVal()});
