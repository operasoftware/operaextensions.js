...
c[e])},A=function(a,c){for(var e=0,g=a.length;e<g;e++)if(a[e][0]===c)return e;return-1},y=function(a){var c=a._promiseCallbacks;c||(c=a._promiseCallbacks={});return c},s=n.EventTarget={mixin:function(a){a.on=this.on;a.off=this.off;a.trigger=this.trigger;return a},on:function(a,c,e){for(var g=y(this),b,d,a=a.split(/\s+/),e=e||this;d=a.shift();)(b=g[d])||(b=g[d]=[]),-1===A(b,c)&&b.push([c,e])},off:function(a,c){for(var e=y(this),g,b,a=a.split(/\s+/);g=a.shift();)c?(g=e[g],b=A(g,c),-1!==b&&g.splice(b,
1)):e[g]=[]},trigger:function(a,c){var e,g,b,d;if(e=y(this)[a])for(var f=0,h=e.length;f<h;f++)g=e[f],b=g[0],g=g[1],"object"!==typeof c&&(c={detail:c}),d=new F(a,c),b.call(g,d)}},t=n.Promise=function(){this.on("promise:resolved",function(a){this.trigger("success",{detail:a.detail})},this);this.on("promise:failed",function(a){this.trigger("error",{detail:a.detail})},this)},B=function(){},C=function(a,c,e,b){var d,f;if(e)try{d=e(b.detail)}catch(h){f=h}else d=b.detail;if(d instanceof t)d.then(function(a){c.resolve(a)},
function(a){c.reject(a)});else if(e&&d)c.resolve(d);else if(f)c.reject(f);else c[a](d)};t.prototype={then:function(a,c){var e=new t;this.on("promise:resolved",function(c){C("resolve",e,a,c)});this.on("promise:failed",function(a){C("reject",e,c,a)});return e},resolve:function(a){n.async(function(){this.trigger("promise:resolved",{detail:a});this.isResolved=a},this);this.reject=this.resolve=B},reject:function(a){n.async(function(){this.trigger("promise:failed",{detail:a});this.isRejected=a},this);this.reject=
...
null}})):w(this,"dispatchEvent",[new o("message",{data:a,source:{postMessage:function(a){d.postMessage(a)},tabId:e&&e.tab?e.tab.id:null}})]);b&&b({})}.bind(this),this._localPort.onMessage.addListener(a),chrome.extension.onMessage.addListener(a),w(this,"dispatchEvent",[new o("connect",{source:this._localPort})]))};u.prototype=Object.create(d.prototype);u.prototype.postMessage=function(a){this._isBackground?this.broadcastMessage(a):this._localPort&&this._localPort.postMessage(a)};var f=function(){u.call(this,
!1)};f.prototype=Object.create(u.prototype);f.prototype.__defineGetter__("bgProcess",function(){return chrome.extension.getBackgroundPage()});var p=i.extension=i.extension||new f;i.contexts=i.contexts||{};f.prototype.getFile=function(a){var c=null;if("string"!=typeof a)return c;try{var e=chrome.extension.getURL("");0==a.indexOf("widget:")&&(a=a.replace("widget:","chrome-extension:"));0==a.indexOf("/")&&(a=a.substring(1));var a=(-1==a.indexOf(e)?e:"")+a,b=new XMLHttpRequest;b.onloadend=function(){b.readyState==
b.DONE&&200==b.status&&(result=b.response,result.name=a.substring(a.lastIndexOf("/")+1),result.lastModifiedDate=null,result.toString=function(){return"[object File]"},c=result)};b.open("GET",a,!1);b.responseType="blob";b.send(null)}catch(d){}return c};var k=function(){Object.defineProperty(this,"length",{value:0,writable:!0});Object.defineProperty(k.prototype,"getItem",{value:function(a){a=this[a];return void 0===a?null:a}});Object.defineProperty(k.prototype,"key",{value:function(a){var c=0;for(a in this)if(this.hasOwnProperty(a)){if(c==
...
delete this[c];this.length=0;a||p.postMessage({action:"___O_widgetPreferences_clear_REQUEST"})}})};k.prototype=Object.create(Storage.prototype);f=function(){s.mixin(this);this.properties=h||{};this._preferences=new k;this._preferencesSet={};p.addEventListener("controlmessage",function(a){if(a.data&&a.data.action)switch(a.data.action){case "___O_widget_setup_RESPONSE":for(var c in a.data.attrs)this.properties[c]=a.data.attrs[c];r.WIDGET_API_LOADED=!0;if(a.data._prefs)for(c in a.data._prefs)this._preferences[c]=
a.data._prefs[c],this._preferences.length++;r.WIDGET_PREFERENCES_LOADED=!0;break;case "___O_widgetPreferences_setItem_RESPONSE":this._preferences.setItem(a.data.data.key,a.data.data.val,!0);break;case "___O_widgetPreferences_removeItem_RESPONSE":this._preferences.removeItem(a.data.data.key,!0);break;case "___O_widgetPreferences_clear_RESPONSE":this._preferences.clear(!0)}}.bind(this),!1);p.postMessage({action:"___O_widget_setup_REQUEST"});b.addEventListener("beforeunload",function(){},!1)};f.prototype=
...
function(){return this.properties.author?this.properties.author.href||"":""});f.prototype.__defineGetter__("authorEmail",function(){return this.properties.author?this.properties.author.email||"":""});f.prototype.__defineGetter__("version",function(){return this.properties.version||""});f.prototype.__defineGetter__("preferences",function(){return this._preferences});b.widget=b.widget||new f;if(b.opera)m=!0,i.isReady=function(a){a.call(i);for(var a=0,c=j.length;a<c;a++){var b=j[a];b.target[b.methodName].apply(b.target,
b.args)}j=[]};else{var d=function(a,c){var e=a.addEventListener;a.addEventListener=function(d,f,h){d.toLowerCase()===c.toLowerCase()?void 0===f||(null===f||"[object Function]"!==Object.prototype.toString.call(f))||(m?f.call(b):l[c.toLowerCase()].push(f)):e.call(a,d,f,h)};a.__defineSetter__("on"+c.toLowerCase(),function(b){a.addEventListener(c.toLowerCase(),b,!1)})},q=function(a,c){for(var b=a.toLowerCase(),d=new o(b,{}),f=0,h=l[b].length;f<h;f++)l[b][f].call(c,d)},l={isready:[],readystatechange:[],
...
var E="uninitialized";b.document.__defineSetter__("readyState",function(b){E=b});b.document.__defineGetter__("readyState",function(){return E});d(b,"load");d(b.document,"domcontentloaded");d(b,"domcontentloaded");d(b.document,"readystatechange");var G=(new Date).getTime()+3E3;(function g(){if((new Date).getTime()>=G)console.warn("opera.isReady check timed out"),v=!0;else for(var d in r)if(!0!==r[d]){b.setTimeout(function(){g()},20);return}b.setTimeout(function(){if(!m){for(var d=0,f=l.isready.length;d<
f;d++)l.isready[d].call(b);l.isready=[];var g=(new Date).getTime()+3E3;(function H(){var d=(new Date).getTime();if(D||v||d>=g){b.document.readyState="interactive";q("readystatechange",b.document);q("domcontentloaded",b.document);d>=g&&console.warn("document.domcontentloaded event fired on check timeout");var f=(new Date).getTime()+3E3;(function I(){var d=(new Date).getTime();if(v||d>=f){b.document.readyState="complete";q("readystatechange",b.document);q("load",window);d>=f&&console.warn("window.load event fired on check timeout");
