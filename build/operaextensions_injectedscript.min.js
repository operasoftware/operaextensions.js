...
g=c.getContext("2d"),e=new Image;e.onload=function(){c.width=e.width;c.height=e.height;g.drawImage(e,0,0);var b=g.getImageData(0,0,c.width,c.height);a.call(this,b)};e.src=d.data.dataUrl;h.removeEventListener("controlmessage",b)}}.bind(this);h.addEventListener("controlmessage",b);h.postMessage({action:"___O_getScreenshot_REQUEST"})};var h=i.extension=i.extension||new c;i.contexts=i.contexts||{};var l=function(){Object.defineProperty(this,"length",{value:0,writable:!0});Object.defineProperty(l.prototype,
"getItem",{value:function(a){return this[a]}});Object.defineProperty(l.prototype,"key",{value:function(a){var b=0;for(a in this)if(this.hasOwnProperty(a)){if(b==a)return a;b++}return null}});Object.defineProperty(l.prototype,"removeItem",{value:function(a,b){this.hasOwnProperty(a)&&(delete this[a],this.length--,b||h.postMessage({action:"___O_widgetPreferences_removeItem_REQUEST",data:{key:a}}))}});Object.defineProperty(l.prototype,"setItem",{value:function(a,b,d){this[a]||this.length++;this[a]=b;
d||h.postMessage({action:"___O_widgetPreferences_setItem_REQUEST",data:{key:a,val:b}})}});Object.defineProperty(l.prototype,"clear",{value:function(a){for(var b in this)this.hasOwnProperty(b)&&delete this[b];this.length=0;a||h.postMessage({action:"___O_widgetPreferences_clear_REQUEST"})}})};l.prototype=Object.create(Storage.prototype);c=function(){this.properties={};this._preferences=new l;this._preferencesSet={};h.addEventListener("controlmessage",function(a){if(a.data&&a.data.action)switch(a.data.action){case "___O_widget_setup_RESPONSE":for(var b in a.data.attrs)this.properties[b]=
...
else for(var c in q)if(!0!==q[c]){window.setTimeout(function(){f()},20);return}window.setTimeout(function(){if(!m){for(var c=0,e=j.isready.length;c<e;c++)j.isready[c].call(window);j.isready=[];(function G(){D||w?(C("domcontentloaded",document),function H(){if(w){C("load",window);for(var c=0,e=k.length;c<e;c++){var f=k[c];f.target[f.methodName].apply(f.target,f.args)}k=[]}else window.setTimeout(function(){H()},20)}()):window.setTimeout(function(){G()},20)})();m=!0}},0)})();i.isReady=function(c){m?
