...
a.windowId;a.index=d.position}this===g.tabs&&(b.properties.index=a.index=g.windows.getLastFocused().tabs.length);b._windowParent.tabs.addTab(b,b.properties.index);g.tabs.addTab(b);this.enqueue(chrome.tabs.create,a,function(a){for(var d in a)d!="url"&&(b.properties[d]=a[d]);if(this!==g.tabs){this.removeTab(b);this.addTab(b,b.properties.index)}b.resolve(true);this.dispatchEvent(new j("create",{tab:b,prevWindow:b._windowParent,prevTabGroup:null,prevPosition:NaN}));this.dequeue()}.bind(this));return b};
r.prototype.getAll=function(){for(var a=[],d=0,b=this.length;d<b;d++)a[d]=this[d];return a};r.prototype.getSelected=function(){return this._lastFocusedTab||this[0]};r.prototype.getFocused=r.prototype.getSelected;r.prototype.close=function(a){if(!a||!(a instanceof h))throw new p("Type mismatch","Expected browserTab argument to be of type BrowserTab.");a.close()};var N=function(){function a(a,b){if(!this._blackList[a]){for(var c=-1,e=0,f=this.length;e<f;e++)if(this[e].properties.id==a){c=e;break}if(!(0>
c)&&(c=this[c]))c._oldWindowParent?c._oldWindowParent.tabs.removeTab(c):c._windowParent.tabs.removeTab(c),c._windowParent.tabs.addTab(c,b.toIndex),c.dispatchEvent(new j("move",{tab:c,prevWindow:c._oldWindowParent,prevTabGroup:null,prevPosition:c._oldIndex})),this.dispatchEvent(new j("move",{tab:c,prevWindow:c._oldWindowParent,prevTabGroup:null,prevPosition:c._oldIndex})),void 0!==c._oldWindowParent&&delete c._oldWindowParent,void 0!==c._oldIndex&&delete c._oldIndex}}r.call(this);this._blackList={};
chrome.tabs.onCreated.addListener(function(a){l.setTimeout(function(){if(!this._blackList[a.id]){for(var b=-1,c=0,e=this.length;c<e;c++){if(this[c].rewriteUrl&&this[c].properties.url==a.url){if(this[c]._windowParent&&this[c]._windowParent.properties.id!==a.windowId)for(var f=0,e=g.windows.length;f<e;f++)g.windows[f].properties.id==a.windowId&&(this[c]._windowParent.tabs.removeTab(this[c]),this[c].properties.index=this[c]._windowParent.tabs.length,this[c]._windowParent=g.windows[f],this[c].properties.windowId=
a.windowId,g.windows[f].tabs.addTab(this[c],this[c].properties.index));for(f in a)"url"==f||"windowId"==f||(this[c].properties[f]=a[f]);this[c].url=this[c].rewriteUrl;delete this[c].rewriteUrl;return}if(this[c].properties.id==a.id){b=c;break}}if(0>b){for(var i,f=u.extension.windows,c=0,e=f.length;c<e;c++)if(f[c].properties.id==a.windowId){i=f[c];break}i||(i=g.windows.getLastFocused());c=new h(a,i);c._windowParent.tabs.addTab(c,c.properties.index);this.addTab(c);c.resolve(!0)}else{for(c in a)this[b].properties[c]=
a[c];c=this[b]}c._windowParent.tabs.dispatchEvent(new j("create",{tab:c,prevWindow:c._windowParent,prevTabGroup:null,prevPosition:NaN}));this.dispatchEvent(new j("create",{tab:c,prevWindow:c._windowParent,prevTabGroup:null,prevPosition:NaN}))}}.bind(this),200)}.bind(this));chrome.tabs.onRemoved.addListener(function(a){if(!this._blackList[a]){for(var b=-1,c=0,e=this.length;c<e;c++)if(this[c].properties.id==a){b=c;break}if(!(0>b)){a=this[b];c=a._oldWindowParent;b=a._oldIndex||a.properties.index;if(!c&&
void 0!==a._windowParent&&null!==a._windowParent){a.properties.closed=!0;a._windowParent.tabs.removeTab(a);this.removeTab(a);c=0;for(e=a._windowParent.tabs.length;c<e;c++)!0==a._windowParent.tabs[c].properties.active?a._windowParent.tabs[c].focus():a._windowParent.tabs[c].properties.active=!1;a.properties.index=NaN;c=a._windowParent;a._windowParent=null}a.dispatchEvent(new j("close",{tab:a,prevWindow:c,prevTabGroup:null,prevPosition:b}));c&&c.tabs.dispatchEvent(new j("close",{tab:a,prevWindow:c,prevTabGroup:null,
prevPosition:b}));this.dispatchEvent(new j("close",{tab:a,prevWindow:c,prevTabGroup:null,prevPosition:b}))}}}.bind(this));chrome.tabs.onUpdated.addListener(function(a,b,c){for(var b=-1,e=0,f=this.length;e<f;e++)if(this[e].properties.id==a){b=e;break}if(!(0>b)){var a=this[b],g;for(g in c)"id"==g||"windowId"==g||(a.properties[g]=c[g]);!0==a.properties.active&&(a._windowParent&&a._windowParent.tabs._lastFocusedTab!==a)&&a.focus()}}.bind(this));chrome.tabs.onMoved.addListener(a.bind(this));chrome.tabs.onAttached.addListener(function(d,
b){for(var c=-1,e=0,f=this.length;e<f;e++)if(this[e].properties.id==d){c=e;break}if(!(0>c)){var i=this[c];i._oldWindowParent&&i._oldWindowParent.tabs.removeTab(i);l.setTimeout(function(){for(var c=0,e=g.windows.length;c<e;c++)if(g.windows[c].properties.id==b.newWindowId){i._windowParent=g.windows[c];i.properties.index=b.newPosition;break}c={windowId:b.newWindowId,toIndex:b.newPosition};a.bind(this).call(this,d,c)}.bind(this),200)}}.bind(this));chrome.tabs.onDetached.addListener(function(a){for(var b=
-1,c=0,e=this.length;c<e;c++)if(this[c].properties.id==a){b=c;break}if(!(0>b)&&(a=this[b]))a._oldWindowParent=a._windowParent,a._oldIndex=a.position}.bind(this));chrome.tabs.onActivated.addListener(function(a){if(!this._blackList[a.tabId]&&a.tabId)for(var b=0,c=this.length;b<c;b++)if(this[b].properties.id==a.tabId&&(this[b].properties.active=!0,this[b]._windowParent)){this[b]._windowParent.tabs._lastFocusedTab=this[b];g.windows._lastFocusedWindow===this[b]._windowParent&&(g.tabs._lastFocusedTab=this[b]);
b=0;for(c=this[b]._windowParent.tabs.length;b<c;b++)this[b]._windowParent.tabs[b]!==this[b]&&(this[b]._windowParent.tabs[b].properties.active=!1)}}.bind(this));g.addEventListener("controlmessage",function(a){if(a.data&&a.data.action&&"___O_getScreenshot_REQUEST"===a.data.action&&a.source.tabId){for(var b=null,c=0,e=this.length;c<e;c++)if(this[c].properties.id==a.source.tabId){b=this[c];break}if(null!==b&&b._windowParent&&!0!=b._windowParent.properties.closed)try{chrome.tabs.captureVisibleTab(b._windowParent.properties.id,
{},function(b){a.source.postMessage({action:"___O_getScreenshot_RESPONSE",dataUrl:b||null})}.bind(this))}catch(f){}else a.source.postMessage({action:"___O_getScreenshot_RESPONSE",dataUrl:void 0})}}.bind(this))};N.prototype=Object.create(r.prototype);for(o in r.prototype)r.prototype.hasOwnProperty(o)&&(N.prototype[o]=r.prototype[o]);var h=function(a,d,b){if(!d)throw new p("Parent missing","BrowserTab objects can only be created with a window parent provided");n.call(this);this._windowParent=d;this.sanitizeProperties=
function(a){void 0!==a.focused?(a.active=!!a.focused,delete a.focused):!0!==a.active&&(a.active=!1);void 0!==a.locked&&(a.pinned=!!a.locked,delete a.locked);if(void 0===a.url||null===a.url)a.url="chrome://newtab";void 0!==a.position&&(a.index=a.position,delete a.position);if(void 0===a.index||null===a.index)a.index=this._windowParent.tabs.length;void 0!==a.closed&&delete a.closed;return a};this.properties=this.sanitizeProperties(a||{});this._operaId=Math.floor(1E16*Math.random());b||(this.rewriteUrl=
this.properties.url,this.properties.url="chrome://newtab/#"+this._operaId);!0==this.properties.active&&this.focus()};h.prototype=Object.create(n.prototype);h.prototype.__defineGetter__("id",function(){return this._operaId});h.prototype.__defineGetter__("closed",function(){return void 0!==this.properties.closed?!!this.properties.closed:!1});h.prototype.__defineGetter__("locked",function(){return void 0!==this.properties.pinned?!!this.properties.pinned:!1});h.prototype.__defineGetter__("focused",function(){return void 0!==
this.properties.active?!!this.properties.active:!1});h.prototype.__defineSetter__("focused",function(a){this.properties.active=!!a;!0==this.properties.active&&this.focus()});h.prototype.__defineGetter__("selected",function(){return void 0!==this.properties.active?!!this.properties.active:!1});h.prototype.__defineSetter__("selected",function(a){this.properties.active=!!a;!0==this.properties.active&&this.focus()});h.prototype.__defineGetter__("private",function(){return void 0!==this.properties.incognito?
!!this.properties.incognito:!1});h.prototype.__defineGetter__("faviconUrl",function(){return this.properties.closed?"":this.properties.favIconUrl||""});h.prototype.__defineGetter__("title",function(){return this.properties.closed?"":this.properties.title||""});h.prototype.__defineGetter__("url",function(){return this.properties.closed?"":this.properties.url||""});h.prototype.__defineSetter__("url",function(a){this.properties.url=a+"";this.enqueue(chrome.tabs.update,this.properties.id,{url:this.properties.url},
function(){this.dequeue()}.bind(this))});h.prototype.__defineGetter__("readyState",function(){return void 0!==this.properties.status?this.properties.status:"loading"});h.prototype.__defineGetter__("browserWindow",function(){return this._windowParent});h.prototype.__defineGetter__("tabGroup",function(){return null});h.prototype.__defineGetter__("position",function(){return void 0!==this.properties.index?this.properties.index:NaN});h.prototype.focus=function(){if(!0!=this.properties.active){this.properties.active=
!0;if(this._windowParent){this._windowParent.tabs._lastFocusedTab=this;g.windows._lastFocusedWindow===this._windowParent&&(g.tabs._lastFocusedTab=this);for(var a=0,d=this._windowParent.tabs.length;a<d;a++)this._windowParent.tabs[a]!==this&&(this._windowParent.tabs[a].properties.active=!1)}this.enqueue(chrome.tabs.update,this.properties.id,{active:!0},function(){this.dequeue()}.bind(this))}};h.prototype.update=function(a){var d={};void 0!==a.focused&&(this.properties.active=d.active=!!a.focused);void 0!==
a.url&&null!==a.url&&(this.propeerties.url=d.url=a.url);this.enqueue(chrome.tabs.update,this.properties.id,d,function(){this.dequeue()}.bind(this))};h.prototype.refresh=function(){};h.prototype.postMessage=function(a){if(!0===this.properties.closed)throw new p("Invalid state","The current BrowserTab object is in the closed state and therefore is invalid.");this.enqueue(chrome.tabs.sendMessage,this.properties.id,a,function(){this.dequeue()}.bind(this))};h.prototype.getScreenshot=function(a){if(!0===
this.properties.closed)throw new p("Invalid state","The current BrowserTab object is in the closed state and therefore is invalid.");if(!this._windowParent||!0===this._windowParent.properties.closed)a.call(this,void 0);else try{this.enqueue(chrome.tabs.captureVisibleTab,this._windowParent.properties.id,{},function(b){if(b){var c=document.createElement("canvas"),d=c.getContext("2d"),f=new Image;f.onload=function(){c.width=f.width;c.height=f.height;d.drawImage(f,0,0);var b=d.getImageData(0,0,c.width,
c.height);a.call(this,b);this.dequeue()}.bind(this);f.src=b}else a.call(this,void 0);this.dequeue()}.bind(this))}catch(d){}};h.prototype.close=function(){if(!0==this.properties.closed)throw new p("Invalid state","The current BrowserTab object is already closed. Cannot call close on this object.");this.properties.closed=!0;this.properties.active=!1;this._oldWindowParent=this._windowParent;this._windowParent=null;this._oldIndex=this.properties.index;this.properties.index=void 0;this._oldWindowParent&&
