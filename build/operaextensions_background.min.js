...
function(a){this.properties.width=a});s.prototype.__defineGetter__("height",function(){return this.properties.height});s.prototype.__defineSetter__("height",function(a){this.properties.height=a});var o=function(a){m.call(this);this.properties={};this.properties.disabled=a.disabled||!1;this.properties.title=a.title||"";this.properties.icon=a.icon||"";this.properties.popup=new s(a.popup||{});this.properties.badge=new p(a.badge||{})};o.prototype=Object.create(m.prototype);o.prototype.apply=function(){!0===
...
var e=(new Date).getTime()+3E3;(function S(){var d=(new Date).getTime();if(G||d>=e){P("load",window);d>=e&&console.warn("window.load event fired on check timeout");for(var d=0,f=u.length;d<f;d++){var g=u[d];g.target[g.methodName].apply(g.target,g.args)}u=[]}else l.setTimeout(function(){S()},50)})()}else l.setTimeout(function(){R()},50)})();x=!0}},0)})();q.isReady=function(d){x?d.call(l):t.isready.push(d)}}l.opera=q}(window);
