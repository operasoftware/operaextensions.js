...
var k=function(){z.call(this)};k.prototype=Object.create(z.prototype);var e=o.extension=o.extension||new k,i=o.contexts=o.contexts||{};k.prototype.getFile=function(a){var b=null;if("string"!=typeof a)return b;try{var c=chrome.extension.getURL("");0==a.indexOf("widget:")&&(a=a.replace("widget:","chrome-extension:"));var a=(-1==a.indexOf(c)?c:"")+a,d=new XMLHttpRequest;d.onloadend=function(){d.readyState==d.DONE&&200==d.status&&(result=d.response,result.name=a.substring(a.lastIndexOf("/")+1),result.lastModifiedDate=
null,result.toString=function(){return"[object File]"},b=result)};d.open("GET",a,!1);d.responseType="blob";d.send(null)}catch(e){}return b};var s=function(){Object.defineProperty(this,"_storage",{value:localStorage});Object.defineProperty(this,"length",{value:0,writable:!0});Object.defineProperty(s.prototype,"getItem",{value:function(a){a=this._storage.getItem(a);return null===a?void 0:a}.bind(this)});Object.defineProperty(s.prototype,"key",{value:function(a){return this._storage.key(a)}.bind(this)});
