...
t.prototype.__defineSetter__("icon",function(a){this.properties.icon=""+a;k.enqueue(this,function(a){chrome.browserAction.setIcon({path:this.icon});a()}.bind(this))});t.prototype.__defineGetter__("popup",function(){return this.properties.popup});t.prototype.__defineGetter__("badge",function(){return this.properties.badge});L.toolbar=L.toolbar||new q;var A=function(a,e,b){if("click"==a){for(var c=null,d=h.tabs.getAll(),f=0;f<d.length;f++)d[f].properties.id==e.tab.id&&d[f].browserWindow.properties.id==
e.tab.windowId&&(c=d[f]);a=i(a,{documentURL:e.info.pageUrl,pageURL:e.info.pageUrl,isEditable:e.info.editable,linkURL:e.info.linkUrl||null,mediaType:e.info.mediaType||null,selectionText:e.info.selectionText||null,source:c,srcURL:e.info.srcUrl||null})}else a=i(a,e);Object.defineProperty(a,"target",{enumerable:!0,configurable:!1,get:function(){return b||null},set:function(){}});return a};A.prototype=Object.create(aa.prototype);var fa=function(){var a={};E.mixin(a);var e=null;Object.defineProperty(this,
